...
/**
 * module: www/pionir/xmlrpc/obj.attach.upload.php
 * @author steffen
 *
 */
class UT_obj_attach_upload_php extends gUnitTestSub {
...
function dotest( &$sql, $options ) {
	...
	$relurl = $_SESSION['s_sessVars']['DocRootURL'].'/pionir/xmlrpc/obj.attach.upload.php';
